...
public class Node {
    ...
    // brothers
    private List<Node> m_lstBrothers = new ArrayList<Node>();
    ...
    // get Brothers list (referenced)
    public List<Node> getBrothers() {
        return m_lstBrothers;
    }

    public boolean addBrother(Node firstNode) {
        return m_lstBrothers.add(firstNode);
    }
    ...
    public void cloneBrothers(Node node) {
        for (Node brother : node.getBrothers()) {
            Node nb = (Node) brother.clone();
            this.addBrother(nb);
        }
    }
