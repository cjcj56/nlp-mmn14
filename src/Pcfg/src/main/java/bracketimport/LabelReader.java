 ...
 * 
 *       Definition: reads the node label from input Role: create a coresponding
 *       node with the label as an identifier Responsibility: distinguish
 *       terminal from non-terminal nodes
 * 
 */
